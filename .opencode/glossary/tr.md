...
- `Smartie` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `Smartie` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `Smartie` inside commands, URLs, package names, or code literals
