...
beforeAll(async () => {
  ...
  mock.module("@smartie-code/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@smartie-code/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@smartie-code/ui/icon", () => ({ Icon: () => null }))
  mock.module("@smartie-code/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
