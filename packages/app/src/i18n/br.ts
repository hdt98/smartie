export const dict = {
  ...
  "dialog.provider.smartie.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.smartie.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.smartieGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Smartie",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Smartie.",
  ...
  "provider.connect.smartieZen.line1":
    "Smartie Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.smartieZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.smartieZen.visit.prefix": "Visite ",
  "provider.connect.smartieZen.visit.link": "opencode.ai/zen",
  "provider.connect.smartieZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Smartie.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Smartie.",
  ...
  "dialog.server.description": "Trocar para qual servidor Smartie este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Smartie ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Smartie",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Smartie ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Smartie inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Smartie dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Smartie",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Smartie aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Smartie é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Smartie iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Smartie.",
