export const dict = {
  ...
  "dialog.provider.smartie.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.smartie.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.smartieGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Smartie",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Smartie-u.",
  ...
  "provider.connect.smartieZen.line1":
    "Smartie Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.smartieZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.smartieZen.visit.prefix": "Posjeti ",
  "provider.connect.smartieZen.visit.link": "opencode.ai/zen",
  "provider.connect.smartieZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Smartie-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Smartie-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Smartie server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Smartie-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Smartie timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Smartie još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Smartie uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Smartie server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Smartie-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Smartie izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Smartie-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Smartie pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Smartie-a.",
