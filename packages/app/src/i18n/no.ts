...
export const dict = {
  ...
  "dialog.provider.smartie.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.smartie.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.smartieGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Smartie",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Smartie.",
  ...
  "provider.connect.smartieZen.line1":
    "Smartie Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.smartieZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.smartieZen.visit.prefix": "Besøk ",
  "provider.connect.smartieZen.visit.link": "opencode.ai/zen",
  "provider.connect.smartieZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Smartie.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Smartie.",
  ...
  "dialog.server.description": "Bytt hvilken Smartie-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Smartie ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Smartie-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Smartie ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Smartie inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Smartie-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Smartie",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Smartie ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Smartie er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Smartie starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Smartie.",
