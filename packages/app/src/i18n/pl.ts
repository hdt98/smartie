export const dict = {
  ...
  "dialog.provider.smartie.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.smartie.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.smartieGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Smartie",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Smartie.",
  ...
  "provider.connect.smartieZen.line1":
    "Smartie Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.smartieZen.visit.prefix": "Odwiedź ",
  "provider.connect.smartieZen.visit.link": "opencode.ai/zen",
  "provider.connect.smartieZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Smartie.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Smartie.",
  ...
  "dialog.server.description": "Przełącz serwer Smartie, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Smartie ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Smartie",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Smartie does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Smartie zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the Smartie server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Smartie",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Smartie na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Smartie.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Smartie",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Smartie.",
