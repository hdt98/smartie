export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Smartie-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Smartie-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
