export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Smartie",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Smartie er blevet downloadet. Vil du installere den og genstarte?",
