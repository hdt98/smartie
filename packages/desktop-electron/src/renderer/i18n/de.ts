export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Smartie",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Smartie wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
