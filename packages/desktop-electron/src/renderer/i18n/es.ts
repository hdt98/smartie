export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Smartie",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Smartie. ¿Quieres instalarla y reiniciar?",
