export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Smartie",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Smartie a été téléchargée. Voulez-vous l'installer et redémarrer ?",
