export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Smartie",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Smartie er lastet ned. Vil du installere den og starte på nytt?",
