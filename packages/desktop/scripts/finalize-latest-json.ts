...
const releaseId = process.env.SMARTIE_RELEASE
if (!releaseId) throw new Error("SMARTIE_RELEASE is required")

const version = process.env.SMARTIE_VERSION
if (!releaseId) throw new Error("SMARTIE_VERSION is required")
