export const dict = {
  ...
  "desktop.menu.help.documentation": "Smartie Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "Smartie CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
