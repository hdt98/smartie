export const dict = {
  ...
  "desktop.menu.help.documentation": "Smartie Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Smartie CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
