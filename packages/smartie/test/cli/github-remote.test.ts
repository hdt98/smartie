...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/smartie.git")).toEqual({ owner: "sst", repo: "smartie" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/smartie")).toEqual({ owner: "sst", repo: "smartie" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/smartie.git")).toEqual({ owner: "sst", repo: "smartie" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/smartie")).toEqual({ owner: "sst", repo: "smartie" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/smartie.git")).toEqual({ owner: "sst", repo: "smartie" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/smartie")).toEqual({ owner: "sst", repo: "smartie" })
})
