...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders SMARTIE_CALLER", () => {
    process.env["SMARTIE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode SMARTIE_CALLER", () => {
    process.env["SMARTIE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown SMARTIE_CALLER", () => {
    process.env["SMARTIE_CALLER"] = "unknown"
